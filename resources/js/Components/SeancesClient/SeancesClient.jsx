  ...
  return (
    <main>
      <section className="movie">
        <div className="movie__info">
          <div className="movie__poster">
            <img className="movie__poster-image" alt="Звёздные войны постер" src="build/assets/i/poster1.jpg" />
          </div>
      ...
      <section className="movie">
        <div className="movie__info">
          <div className="movie__poster">
            <img className="movie__poster-image" alt="Альфа постер" src="build/assets/i/poster2.jpg" />
          </div>
          <div className="movie__description">
      ...
      <section className="movie">
        <div className="movie__info">
          <div className="movie__poster">
            <img className="movie__poster-image" alt="Хищник постер" src="build/assets/i/poster2.jpg" />
          </div>
          <div className="movie__description">
